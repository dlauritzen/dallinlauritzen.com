...
ADMINS = (
    ...
    ('Webmaster', 'webmaster@dallinlauritzen.com'),
)

MANAGERS = ADMINS

# Sensitive data is stored in sensitive.json
import json, os
with open('sensitive.json', 'r') as f:
    sensitive = json.load(f)

DOMAIN_ROOT = sensitive['DOMAIN_ROOT']
...
SECRET_KEY = str(sensitive['SECRET_KEY'])
...
MEDIA_ROOT = '%s/public/media' % DOMAIN_ROOT
